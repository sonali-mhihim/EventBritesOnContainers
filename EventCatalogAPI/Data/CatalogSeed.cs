    ...
    public static class CatalogSeed
    {
        ...
        private static IEnumerable<CatalogEvent> GetCatalogEvents()
        {
            return new List<CatalogEvent>()
            {
                ...
                new CatalogEvent { CatalogTypeId = 3, CatalogHostId = 1, Description = "Travel the world of coffee and more on this 1 hour espresso crash course", Name = "Coffee Workshop", Price = 12, PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/4", Date=new DateTime(2020,10,9,18,30,0), Location="Bellevue, WA" },
                new CatalogEvent { CatalogTypeId = 1, CatalogHostId = 2, Description = "Teens are invited to make Internet-famous iced whipped/dalgona coffee", Name = "Whipped Dalgona Iced Coffee", Price = 0, PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/5", Date=new DateTime(2020,7,18,20,0,0), Location="Coffee Reserve at Downtown Park, Sammamish" },
                new CatalogEvent { CatalogTypeId = 2, CatalogHostId = 3, Description = "Kidding around yoga blends the teachings and values of traditional yoga", Name = "Mommy and Me Yoga session", Price = 5, PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/6", Date=new DateTime(2020,11,11,9,0,0), Location="School of Meditation"},
                new CatalogEvent { CatalogTypeId = 2, CatalogHostId = 3, Description = "Learn about meditation, it's history, it's benefits and how to do it", Name = "Online Meditation Event", Price = 50, PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/7", Date=new DateTime(2020,9,6,9,0,0), Location="Online event" },
                new CatalogEvent { CatalogTypeId = 4, CatalogHostId = 5, Description = "Running Through Runyon Canyon", Name = "Running in Runyon", Price = 99, PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/8", Date=new DateTime(2020,9,6, 6,0,0), Location="Runyon Canyon" },
                new CatalogEvent { CatalogTypeId = 4, CatalogHostId = 5, Description = "Profoundly improve the quality of your health, appearance and overall well being!", Name="The Ultimate Nutrition Event", Price=0, PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/9", Date=new DateTime(2020, 10,15,16,0,0), Location="Online event"},
                new CatalogEvent { CatalogTypeId = 1, CatalogHostId = 2, Description = "Join us for a coffe while creating a beautiful painting", Name="Coffee and Paint", Price=35, PictureUrl="http://externalcatalogbaseurltobereplaced/api/pic/10", Date=new DateTime(2020,12,3,18,0,0), Location="Redmond, WA"}
            };
        }
